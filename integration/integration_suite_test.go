...
var _ = SynchronizedBeforeSuite(func() []byte {
	cp, err := gexec.Build("github.com/steve-sienk/gcs-resource/cmd/check")
	Expect(err).ToNot(HaveOccurred())
	ip, err := gexec.Build("github.com/steve-sienk/gcs-resource/cmd/in")
	Expect(err).ToNot(HaveOccurred())
	op, err := gexec.Build("github.com/steve-sienk/gcs-resource/cmd/out")
	Expect(err).ToNot(HaveOccurred())
